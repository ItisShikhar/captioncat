...
**Component type:** `strikethrough`

`strikethrough` draws a line through a word.
...
| `renderOrder` | `RenderOrder` | `inFront` | `inFront`, `behind` |

Zero width disables visible line paint. The line can render in front of or
behind the word surface.
